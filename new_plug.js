(function () {
    ...
    console.log("Modss", "plugin", "LOADED - " + Protocol() + "modss.tv");
    ...
    var Modss = {
        init: function () {
            ...
            if (Lampa.Storage.field("mods_tv_butt_ch"))
                Lampa.Keypad.listener.follow("keydown", function (e) {
                    ...
                    var none =
                        !$(".panel--visible .focus").length &&
                        Lampa.Controller.enabled().name !== "select";
                    if (
                ...
                if (e.name == "select" && !vip) {
                    setTimeout(function () {
                        if (
                            ...
                            $(".selectbox .scroll__body div:eq(0)")
                                .html()
                                .indexOf(".land") >= 0
                        )
            ...
            if (
                Lampa.Storage.get("showModssVip", "false") &&
                leftVipD &&
                vip &&
                logged
            )
            ...
            setTimeout(function () {
                ...
                $("#MRELOAD").on(
                    "hover:enter hover:click hover:touch",
                    function () {
                        location.reload();
                    }
                );
        ...
        online: function (back) {
            ...
            function inf() {
                ...
                _this.balanser_name =
                    (watched[file_id] && watched[file_id].balanser_name) ||
                    false;
                _this.balanser =
                    (watched[file_id] && watched[file_id].balanser) || false;
                _this.data = Lampa.Storage.cache(
                    "online_choice_" + _this.balanser,
                    3000,
                    {}
                );
                _this.is_continue =
                    cards.number_of_seasons &&
                    _this.data[cards.id] &&
                    Lampa.Arrays.getKeys(_this.data[cards.id].episodes_view)
                        .length;
                ...
                Lampa.Select.show({
                    ...
                    onSelect: function onSelect(a) {
                        if (a.yes) {
                            ...
                            Lampa.Storage.set(
                                "online_choice_" + _this.balanser[cards.id],
                                _this.data
                            );
            ...
            var button =
                "<div style='position:relative' data-subtitle='modss_v".concat(
                    manifest.version,
                    " (23 Balansers, 19 in VIP)' class='full-start__button selector view--modss_online'>" +
                        ico +
                        "<span>" +
                        this.title +
            ...
            if (!back && Lampa.Storage.field("mods_onl")) {
                setTimeout(function () {
                    ...
                    if (
                        ...
                        if (activity.find(".button--priority").length) {
                            ...
                            (Lampa.Storage.field("online_but_first") &&
                                activity.find(".button--play").length) ||
                ...
                btn.on("hover:enter", function () {
                    ...
                    if (
                        _this.is_continue &&
                        Lampa.Storage.field("online_continued")
                    )
                        shows(_this.last_s);
                    else openOnline();
                });
                ...
                if (
                    ...
                    item.push({
                        title:
                            ...
                            " - " +
                            Lampa.Arrays.getKeys(Lampa.Storage.get("my_colls"))
                                .length,
                        url: Pub.baseurl + "v1/collections",
                        source: "my_coll",
                    });
        ...
        buttBack: function (pos) {
            if (
                ...
                var position =
                    Lampa.Storage.field("mods_butt_pos") == "left"
        ...
        last_view: function (data) {
            ...
            if (viewed) {
                ...
                if (
                    ...
                    $("body")
                        .find(".timeline")
                        .append(Lampa.Timeline.render(viewed.view));
                }
                if ($("body").find(".filter--sort").length)
                    $("body")
                        .find(".files__left .time-line, .card--last_view")
                        .remove();
        ...
        serialInfo: function (card) {
            if (
                ...
                var last_seria_inseason =
                    card.last_episode_to_air.season_number;
                var air_new_episode = card.last_episode_to_air.episode_number;
                var next_episode = card.next_episode_to_air;
                var last_seria =
                    next_episode &&
                    new Date(next_episode.air_date) <= Date.now()
                ...
                eval(
                    (function (a, b, c) {
                        ...
                        6,
                        "1(!0 || !0.2) 5.3.4();",
                        "API,if,length,location,reload,window".split(",")
                    )
                );

                if (card.next_episode_to_air) {
                    var add_ = "<b>" + last_seria;
                    var notices = Lampa.Storage.get(
                        "account_notice",
                        []
                    ).filter(function (n) {
                    ...
                    if (notices.length) {
                        ...
                        if (notice) {
                            var episod_new = JSON.parse(notice.data).card
                                .seasons;
                            if (
                                Lampa.Utils.parseTime(notice.date).full ==
                                Lampa.Utils.parseTime(Date.now()).full
                            )
                                add_ =
                                    "#{season_new} <b>" +
                                    episod_new[last_seria_inseason];
                        }
                    }
                    new_ser =
                        add_ +
            ...
            return new Promise(function (resolve, reject) {
                if (card) {
                    ...
                    if (
                        ...
                        $(
                            ...
                            '<div style="position:absolute; margin-top: -5em; right: 0;" class="full-start-new__rate-line rating--modss"><div style="width:2em;margin-top:1em;margin-right:1em" class="wait_rating"><div class="broadcast__scan"><div></div></div></div><div class="full-start__rate rate--imdb hide"><div></div><div>IMDB</div></div><div class="full-start__rate rate--kp hide"><div></div><div>KP</div></div></div>'
                        );
                    }
                }
                Pub.network.clear();
                ...
                Pub.network.silent(
                    ...
                    function (json) {
                        ...
                        var kp_rating =
                            !isNaN(kp) && kp !== null
                                ...
                                : "0.0";
                        var imdb_rating =
                            !isNaN(imdb) && imdb !== null
                                ? parseFloat(imdb).toFixed(1)
                                : "0.0";
                        if (
                            card &&
                            ["filmix", "pub"].indexOf(card.source) == -1 &&
                    ...
                    function (a, c) {
                        resolve();
                        Lampa.Noty.show(
                            "MODSs ОШИБКА Рейтинг KP   " +
                                Pub.network.errorDecode(a, c)
                        );
                    },
                    {
            ...
            setTimeout(function () {
                ...
                Lampa.Notice.pushNotice(
                    "modss",
                    {
                        ...
                        title: card.name,
                        text:
                            "Переводы на балансерах где есть " +
                            data.episode +
                            " серия",
                        time: Date.now(),
        ...
        balansers: function () {
            var balansers = {
                ...
                videodb:
                    'VideoDB 4K  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                iremux: 'IRemux 4K  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                hdrezka:
                    'HDRezka  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                zetflix:
                    'Zetflix  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                ...
                aniliberty:
                    'AniLiberty  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                hdvb: 'HDVB  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
                collaps: "Collaps",
                kinotochka:
                    'KinoTochka  <span style="font-weight: 700;color:rgb(236,151,31)">VIP</span>',
        ...
        check: function (name, call) {
            ...
            var u =
                url +
                "/api/v2.0/indexers/" +
                (Lampa.Storage.field("jackett_interview") == "healthy"
                    ? "status:healthy"
                    : "all") +
                "/results?apikey=" +
            ...
            var check = function check(ok) {
                Pub.network["native"](
                    ...
                    function (a, c) {
                        ...
                        Lampa.Noty.show(
                            Pub.network.errorDecode(a, c) + " - " + url
                        );
                        if (name && !call)
                            item2
                                .removeClass("active error wait")
            ...
            if (name && !call) check();
                ...
                if (Boolean(Modss.jack[Lampa.Storage.get("jackett_url2")]))
                    item.removeClass("wait").addClass(
                        Modss.jack[Lampa.Storage.get("jackett_url2")].ok
                            ? "active"
                            : "error"
                    );
            }
        ...
        showModal: function (text, onselect, full, xml, but) {
            Lampa.Modal.open({
                ...
                html:
                    typeof text == "object"
                        ? text
                        : $('<div class="about modssModal">' + text + "</div>"),
                onBack: function onBack() {
                    if (xml) xml.abort();
                    Lampa.Modal.close();
                    Lampa.Controller.toggle("content");
                ...
                buttons: [
                    {
                        name: but
                            ? but[0]
                            : Lampa.Lang.translate("settings_param_no"),
                    ...
                    },
                    {
                        name: but
                            ? but[1]
                            : Lampa.Lang.translate("settings_param_yes"),
                        onSelect: onselect,
                    },
                ],
            });
    ...
    var Filmix = {
        ...
        user_dev:
            "app_lang=ru_RU&user_dev_apk=2.2.9&user_dev_id=" +
            Lampa.Utils.uid(16) +
        ...
        add_new: function () {
            ...
            Lampa.Modal.open({
                ...
                onSelect: function onSelect() {
                    Lampa.Utils.copyTextToClipboard(
                        ...
                        function () {
                            Lampa.Noty.show(
                                Lampa.Lang.translate("filmix_copy_secuses")
                            );
                        },
                        function () {
                            Lampa.Noty.show(
                                Lampa.Lang.translate("filmix_copy_fail")
                            );
                        }
                    );
                },
            ...
            ping_auth = setInterval(function () {
                Filmix.checkPro(user_token, function (json) {
                    if (json && json.user_data) {
                        ...
                        $(
                            '[data-name="filmix_token"] .settings-param__value'
                        ).text(user_token);
                        Lampa.Controller.toggle("settings_component");
                    }
                });
            ...
            this.network.quiet(
                ...
                function (a, c) {
                    Lampa.Noty.show(
                        Filmix.network.errorDecode(a, c) + " - Filmix"
                    );
                }
            );
        },
        showStatus: function (ch) {
            ...
            var statuss = $(".settings-param__status", ch)
                .removeClass("active error wait")
                .addClass("wait");
            ...
            if (status.login) {
                ...
                var foto =
                    '<img width="30em" src="' +
                    (status.foto.indexOf("noavatar") == -1
                        ? status.foto
                        : "./img/logo-icon.svg") +
    ...
    var ForkTV = {
        ...
        openBrowser: function (url) {
            if (Lampa.Platform.is("tizen")) {
                var e = new tizen.ApplicationControl(
                    "https://tizen.org/appcontrol/operation/view",
                    url
                );
        ...
        but_add: function () {
            ...
            if (
                Lampa.Storage.get("mods_fork") &&
                Lampa.Storage.get("forktv_auth")
            )
        ...
        updMac: function (itm) {
            ...
            Lampa.Noty.show(
                "CODE " + Lampa.Lang.translate("succes_update_noty")
            );
        },
        parse: function () {
        ...
        check_forktv: function (itm, ar, upd) {
            var status = $(".settings-param__status", itm)
                .removeClass("active error wait")
                .addClass("wait");
            this.network["native"](
                ...
                function (json) {
                    if (json.channels.length === 1) {
                        ...
                        if (ar) {
                            ...
                            $(".settings-param__descr", itm).text(
                            ...
                            $("body").find('[data-action="forktv"]').remove();
                            $(
                                '.settings [data-static="true"]:eq(1), .settings [data-static="true"]:eq(2)'
                            ).hide();
                            $(
                                ...
                                .addClass("error");
                            $(
                                '.settings [data-static="true"]:eq(0) .settings-param__descr'
                            ).text(Lampa.Lang.translate("filmix_nodevice"));
                        }
                    } else {
                        ForkTV.but_add();
                        ...
                        if (itm) {
                            if (
                                itm.text().indexOf("код") == -1 ||
                                itm.text().indexOf("code") == -1
                            )
            ...
            ForkTV.check(ForkTV.url, function (json) {
                ...
                if (title.indexOf("Много") >= 0) {
                    ...
                    var dat =
                        ...
                        '<img src="' + json.channels[0].logo_30x30 + '">';
                    modal = $(
                ...
                function (json) {
                    if (json) {
                        if (ar && json.channels.length > 1) {
                            ...
                            json.channels[0].title.indexOf("Много IP") >= 0
                        ) {
    ...
    var Pub = {
        network: new Lampa.Reguest(),
        baseurl: "https://api.srvkp.com/", //https://api.apweb.vip/',
        tock: "uirmqgdg5s3w9sq05udmjlca897oxrgk",
        token: Lampa.Storage.get(
            "pub_access_token",
            ...
            var check = function check(url, call) {
                ...
                Pub.network.silent(
                    ...
                    function (json) {
                        ...
                        Pub.network.silent(
                            Pub.baseurl +
                                "v1/device/info?access_token=" +
                                json.access_token,
                            function (json) {
                                Pub.network.silent(
                                    Pub.baseurl +
                                        "v1/device/notify?access_token=" +
                                        Pub.token,
                                    function (json) {
                                        if (call) call();
                                    },
                                    ...
                                    },
                                    {
                                        title: Lampa.Platform.is("android")
                                            ...
                                            : uas[0] +
                                              " " +
                                              Lampa.Platform.get().toUpperCase(),
                                        hardware: Lampa.Platform.is("android")
                                            ? "Android 10"
                                            : uas[2],
        ...
        refreshTok: function () {
            this.network.silent(
                ...
                function (a, c) {
                    Lampa.Noty.show(
                        Pub.network.errorDecode(a, c) + " - KinoPub"
                    );
                },
                {
                ...
                this.network.silent(
                    ...
                    function (json) {
                        if (json.user.username.indexOf("MODSS") == -1) {
                            $(
                                ".settings-param__" + (!ur ? "name" : "descr"),
                                itm
                            ).html(
                                '<img width="30em" src="' +
                            ...
                            $(
                                ".settings-param__" + (!ur ? "descr" : ""),
                                itm
                            ).html(
                                Lampa.Lang.translate("pub_title_regdate") +
                                    " " +
                                    Lampa.Utils.parseTime(
                                        json.user.reg_date * 1000
                                    ).full +
                                    "<br>" +
                                    (json.user.subscription.active
                                        ? Lampa.Lang.translate(
                                          ...
                                          " " +
                                          Lampa.Utils.parseTime(
                                              json.user.subscription.end_time *
                                                  1000
                                          ).full
                            ...
                            $(
                                ".settings-param__" + (!ur ? "name" : "descr"),
                                itm
                            ).html(Lampa.Lang.translate("filmix_nodevice"));
                        status.removeClass("wait").addClass("active");
                        Lampa.Storage.set("logined_pub", true);
                        Lampa.Storage.set(
                            "pro_pub",
            ...
            this.network.silent(
                ...
                function (json) {
                    ...
                    Lampa.Arrays.getKeys(opt).forEach(function (key) {
                        ...
                        if (
                            !k.type &&
                            ["supportHevc", "support4k"].indexOf(key) > -1
                        )
                            item.push({
                                title: k.label,
                                value: k.value,
        ...
        delete_device: function (call) {
            this.network.silent(
                ...
                function (json) {
                    Lampa.Noty.show(
                        Lampa.Lang.translate("pub_device_dell_noty")
                    );
                    Lampa.Storage.set("logined_pub", false);
                    Lampa.Storage.set("pub_access_token", "");
        ...
        this.searchs = function (_object) {
            ...
            var src =
                ...
                (object.movie.imdb_id
                    ? encodeURIComponent(object.movie.imdb_id)
                    : "null") +
                "/bm9uZQ==/" +
                fr +
                "?ip=" +
                IP +
                "&search=" +
                encodeURIComponent(select_title);
            lumex_search(
                src,
                function (json) {
                    if (
                        json &&
                        json.folder &&
                        Lampa.Arrays.getKeys(json.folder).length
                    )
                        success(json);
                            ...
                            if (item.season) {
                                ...
                                items.forEach(function (elem) {
                                    var cell = {
                                        ...
                                        error: function (play_item, callback) {
                                            Lampa.Player.timecodeRecording(
                                                false
                                            );
                                            callback(
                                                API.replace("api.", "") +
    ...
    function filmix(component, _object) {
        ...
        this.searchByTitle = function (_object, query) {
            ...
            if (object.movie.source == "filmix")
                return this.find(object.movie.id);
            var search_date =
                object.search_date ||
            ...
            var clean_title = component
                .cleanTitle(select_title)
                .replace(/\b(\d\d\d\d+)\b/g, "+$1");
            if (search_year)
                clean_title = clean_title.replace(
                    new RegExp(" +(" + search_year + ")"),
                    " $1"
                );
            var url = embed + "search";
            url = Lampa.Utils.addUrlComponent(
                url,
                "story=" + encodeURIComponent(clean_title)
            );
            ...
            network.silent(
                ...
                function (json) {
                    ...
                    if (count == 0 && json.length == 0)
                        _this.searchByTitle(object, object.search_two) &
                            count++;
                    else if (count == 1 && json.length == 0)
                        component.doesNotAnswer(select_title);
                    else {
                        var cards = json.filter(function (c) {
                            if (!c.year && c.alt_name)
                                c.year = parseInt(c.alt_name.split("-").pop());
                            return (
                                !c.year ||
                                !search_year ||
                                (c.year > search_year - 2 &&
                                    c.year < search_year + 2)
                            );
                        });
        ...
        this.find = function (filmix_id) {
                ...
                Filmix.checkPro(
                    ...
                    function (found) {
                        ...
                        if (found && found.user_data) {
                            ...
                            window.FX.max_qualitie = 720;
                            if (
                                found.user_data.is_pro ||
                                found.user_data.is_pro_plus
                            )
                                window.FX.is_max_qualitie = true;
                            if (found.user_data.is_pro)
                                window.FX.max_qualitie = 1080;
                            if (found.user_data.is_pro_plus)
            ...
            function end_search(filmix_id) {
                ...
                network["native"](
                    prox + embed + "post/" + filmix_id + "?" + dev_token,
                    function (found) {
                        if (found) {
                            found = {
                                ...
                                max: found.quality,
                                quality:
                                    (found.rip && found.rip.split(" ")[0]) ||
                                    found.rip,
                            };
                            if (
                                found &&
                                Lampa.Arrays.getKeys(found).length &&
                                (found.movie.length ||
                                    Lampa.Arrays.getKeys(found.playlist).length)
                            ) {
                                success(found);
                                component.loading(false);
                            } else component.doesNotAnswer(select_title);
            ...
            if (results.playlist && Object.keys(results.playlist).length > 0) {
                ...
                for (var seasons in results.playlist) {
                    ...
                    filter_items.season.push(
                        Lampa.Lang.translate("torrent_serial_season") +
                            " " +
                            seasons
                    );
                }
                Lampa.Arrays.getKeys(
                    results.playlist[
                        filter_items.season[choice.season].split(" ")[1]
                    ]
                ).forEach(function (v) {
        ...
        function getQuality(link) {
            ...
            if (qualities)
                qualities = qualities[1]
                    ...
                    .filter(function (elem) {
                        return (
                            parseInt(elem) <= window.FX.max_qualitie &&
                            parseInt(elem) !== 0
                        );
                    })
                    .sort(function (a, b) {
            ...
            var qualitie =
                (qualities.length > 0 && Math.max.apply(null, qualities)) ||
                false;
            return {
                max: qualitie,
                quals: qualities,
        ...
        function filtred() {
            ...
            if (results.playlist && Object.keys(results.playlist).length > 0) {
                for (var seasons in results.playlist) {
                    if (seasons == filter_items.season_id[choice.season]) {
                        var season =
                            results.playlist[seasons][
                                filter_items.voice[choice.voice]
                            ];
                        for (var episode in season) {
                            var eps = season[episode];
                            var quality = season[episode].qualities
                                .filter(function (elem) {
                                    return (
                                        parseInt(elem) <=
                                            window.FX.max_qualitie &&
                                        parseInt(elem) !== 0
                                    );
                                })
                                .sort(function (a, b) {
            ...
            return component.order[choice.order].id == "invers"
                ? filtred.reverse()
                : filtred;
        }
            ...
            if (element.qualityes) {
                ...
                if (qualities) {
                    qualities.forEach(function (q) {
                        var files =
                            object.movie.number_of_seasons || element.season
                                ? element.link.replace(/%s(\.mp4)/i, q + "$1")
    ...
    function kinopub(component, _object) {
        ...
        this.searchByTitle = function (_object, query) {
            ...
            var orig =
                object.movie.original_title || object.movie.original_name;
            var imdb =
                object.movie.imdb_id && parseInt(object.movie.imdb_id.slice(2));
            ...
            network.silent(
                ...
                function (json) {
                    if (Lampa.Arrays.getKeys(json.item).length) {
                        network.silent(
                            embed.slice(0, -6) +
                                "/device/info?access_token=" +
                                Pub.token,
                            function (param) {
                                streamingType =
                                    param.device.settings.streamingType.value.find(
                                        function (t) {
                                            return t.selected == 1;
                                        }
                                    );
                                supportHevc =
                                    param.device.settings.supportHevc.value ==
                                    1;
        ...
        function filtred() {
            ...
            if (results.seasons) {
                results.seasons.forEach(function (season) {
                    if (
                        season.number ==
                        parseInt(filter_items.season[choice.season])
                    ) {
                        ...
                        ((track.channels &&
                            " - " +
                                (track.channels == 6
                                    ...
                                    : track.channels)) ||
                            "") +
                        ((track.type && " - " + track.type.title) || "") +
                        ((track.author && " - " + track.author.title) || ""),
                };
            });
        ...
        function getFile(element) {
            ...
            var quality = {};
            var preferably =
                Lampa.Storage.get("video_quality_default", "1080") + "p";
            /*
  		...
  		*/
            element.file.forEach(function (item) {
                quality[item.quality] =
                    item.url[filter_items.type[choice.type].toLowerCase()];
            });
            ...
            return {
                stream: file,
                quality:
                    ["HLS2", "HLS4"].indexOf(filter_items.type[choice.type]) >
                    -1
                        ? ""
                        : quality,
            };
        ...
        function filtred() {
            ...
            if (filter_items.season.length) {
                for (var season in extract.folder) {
                    var season_id = parseInt(
                        filter_items.season[choice.season].split(" ").pop()
                    );
                    if (season == season_id) {
    ...
    function collaps(component, _object) {
        ...
        var embed = prox
            ? prox + "https://api.topdbltj.ws/embed/"
            : "https://api.marts.ws/embed/";
        var select_title = "";
        var filter_items = {};
            ...
            network.silent(
                ...
                function (a, c) {
                    component.doesNotAnswer(
                        a.status == 404 &&
                            a.responseText &&
                            a.responseText.indexOf("видео недоступно") !== -1
                            ? select_title
                            : ""
                    );
                },
        ...
        function fixUrl(url) {
            url = (url || "").replace(
                atob("Ly9oeWUxZWFpcGJ5NHcubWF0aGFtLndzLw=="),
                atob("Ly9hYi5tYXRoYW0ud3Mv")
            );
            return url;
        }
        function filter() {
        ...
        function filtred() {
            ...
            if (extract.playlist) {
                extract.playlist.seasons.forEach(function (season, i) {
                    ...
                    if (season.season == season_id) {
                        season.episodes.forEach(function (episode) {
                            var resolution = Lampa.Arrays.getKeys(
                                extract.qualityByWidth
                            ).pop();
                            var max_quality = resolution
                                ? extract.qualityByWidth[resolution] || 0
                                : "";
                            var audio_tracks = episode.audio.names.map(
                                function (name) {
                                    return {
                                        language: name,
                                    };
                            ...
                            filtred.push({
                                ...
                                info: episode.audio.names
                                    .slice(0, 5)
                                    .join(", "),
                                subtitles: episode.cc
                                    ? episode.cc.map(function (c) {
                                          return {
                                              label: c.name,
                                              url: fixUrl(c.url || ""),
                                          };
                                    ...
                                    : false,
                                audio_tracks: audio_tracks.length
                                    ? audio_tracks
                                    : false,
                            });
                        });
                ...
                var max_quality = extract.qualityByWidth
                    ? extract.qualityByWidth[resolution] || 0
                    : 0;
                var audio_tracks = extract.source.audio.names.map(function (
                    name
                ) {
                    return {
                        language: name,
                ...
                var file = fixUrl(
                    (prefer_dash && extract.source.dash) ||
                        extract.source.hls ||
                        ""
                );
                filtred.push({
                    ...
                    subtitles: extract.source.cc
                        ? extract.source.cc.map(function (c) {
                              return {
                                  label: c.name,
                                  url: fixUrl(c.url || ""),
                              };
    ...
    function rezka(component, _object) {
            ...
            network["native"](
                ...
                function (a, c) {
                    component.doesNotAnswer(
                        a.status == 404 &&
                            a.responseText &&
                            (a.responseText.indexOf("Видео не найдено") !==
                                -1 ||
        ...
        function getFilm(id, voice) {
            ...
            if (voice) {
                if (extract.season.length) {
                    var ses =
                        extract.season[
                            Math.min(extract.season.length - 1, choice.season)
                        ].id;
                    url +=
                        "serial/" +
                        voice +
        ...
        function getStream(element, call, error) {
            ...
            if (element.season) {
                ...
                url +=
                    "movie/" + element.voice.token + "/iframe?h=gidonline.io";
            }
    ...
    function kinobase(component, _object) {
        ...
        this.searchByTitle = function (_object, query) {
            ...
            var url =
                embed +
                "search?query=" +
                encodeURIComponent(component.cleanTitle(select_title));
            network.clear();
            ...
            network["native"](
                ...
                function (str) {
                    str = str.replace(/\n/g, "");
                    var links = object.movie.number_of_seasons
                        ? str.match(
                              /<div class="title"><a href="\/(serial|tv_show)\/([^"]*)"[^>]*>(.*?)<\/a><\/div>/g
                          )
                        : str.match(
                              /<div class="title"><a href="\/film\/([^"]*)"[^>]*>(.*?)<\/a><\/div>/g
                          );
                    var search_date =
                        object.search_date ||
                        object.movie.release_date ||
                    ...
                    if (links) {
                        ...
                        if (cards.length) {
                            if (select_title) {
                                var _tmp = cards.filter(function (c) {
                                    return component.containsTitle(
                                        c.title,
                                        select_title
                                    );
                                });
                        ...
                        str.indexOf("/recaptcha/api.js") !== -1 ||
                        str.indexOf('form action="/check?') !== -1
                    ) {
                        component.empty(
                            Lampa.Lang.translate("title_kb_captcha_address") +
                                embed
                        );
                    } else component.doesNotAnswer(select_title);
                },
                    ...
                    if (playlist) {
                        if (i == choice.season) {
                            playlist.forEach(function (eps) {
                                if (eps.file) {
                                    component
                                        .parsePlaylist(eps.file)
                                        .forEach(function (el) {
                                            if (
                                                el.voice &&
                                                filter_items.voice.indexOf(
                                                    el.voice
                                                ) == -1
                                            ) {
                        ...
                        component
                            .parsePlaylist(item.file)
                            .forEach(function (el) {
                                if (
                                    el.voice &&
                                    filter_items.voice.indexOf(el.voice) == -1
                                ) {
        ...
        function filtred() {
            ...
            if (is_playlist) {
                ...
                if (
                    extract[choice.season] &&
                    (extract[choice.season].playlist ||
                        extract[choice.season].folder)
                ) {
                    playlist =
                        extract[choice.season].playlist ||
                        extract[choice.season].folder;
                    season = parseInt(
                        extract[choice.season].title ||
                            extract[choice.season].comment ||
                            ""
                    );
                ...
                playlist.forEach(function (eps, index) {
                    ...
                    if (items.length) {
                        ...
                        var alt_voice = (eps.comment || eps.title).match(
                            /\d+ серия (.*)$/i
                        );
                        var info =
                            items[0].voice ||
                            (alt_voice && alt_voice[1].trim()) ||
                            translation;
        ...
        function extractData(str, page) {
            var quality_match = page.match(
                /<li><b>Качество:<\/b>([^<,]+)<\/li>/i
            );
            var translation_match = page.match(
                /<li><b>Перевод:<\/b>([^<,]+)<\/li>/i
            );
            ...
            if (vod[0] == "file") {
                ...
                if (file) {
                    ...
                    component.parsePlaylist(file).forEach(function (item) {
                        ...
                        var quality = quality_str
                            ? parseInt(quality_str[1])
                            : NaN;
            ...
            var call_error = function call_error(a, c) {
                if (
                    ((a.status == 404 || a.status == 403) &&
                        a.responseText &&
                        (a.responseText.indexOf("<title>Not Found</title>") !==
                            -1 ||
        ...
        function filtred() {
            ...
            extract.forEach(function (data) {
                if (data.folder) {
                    ...
                    var m = Lampa.Arrays.getValues(medias).filter(function (
                        itm
                    ) {
                    ...
                    filtred.push({
                        ...
                        title: data.title,
                        quality: m.length
                            ? m[0].source_quality + " - " + m[0].quality + "p"
                            : "",
                        info: "",
                        subtitles: data.subtitle
                            ? parseSubs(data.subtitle)
                            : false,
                    });
                }
            });
    ...
    function component(object) {
        ...
        this.initialize = function () {
            ...
            filter.onSelect = function (type, a, b) {
                if (a.bal) {
                    ...
                    Lampa.Select.close();
                    if (
                        Lampa.Arrays.getKeys(sources).indexOf(a.source) !== -1
                    ) {
                        if (
                            !Lampa.Storage.get("pro_pub", "false") &&
                            a.source == "kinopub"
                        )
                            return Lampa.Noty.show(
                                "Добавьте устройство - Настройки -> Modss -> Онлайн -> KinoPub"
                            );
                        ...
                        Lampa.Noty.show(
                            "Будет Доступно для VIP пользователей<br>Через бот @modssmy_bot"
                        );
                    }
                }
                if (
            ...
            filter
                ...
                .on("hover:enter", function () {
                    $("body")
                        .find(".selectbox__title")
                        .text(Lampa.Lang.translate("modss_balanser"));
                });
            ...
            filter
                .render()
                .find(".filter--filter")
                .after(filter.render().find(".filter--search"));
        ...
        this.createSource = function () {
            var priority_balanser = Lampa.Storage.get(
                "priority_balanser",
                Modss.balansPrf
            );
        ...
        this.proxy = function (name) {
            ...
            if (
                ...
                return proxy_apn;
            else if (need == "on" && need_url.length >= 0 && prox !== "")
                proxy = prox;
            else if (need == "url" || (need == "on" && need_url.length > 0))
                proxy = need_url;
        ...
        this.find = function () {
            ...
            var vcdn_search = function vcdn_search() {
                ...
                if (balanser == "videoapi") {
                    ...
                    url = Lampa.Utils.addUrlComponent(
                        url,
                        "api_token=qR0taraBKvEZULgjoIRj69AJ7O6Pgl9O"
                    );
                } else {
                ...
                if (object.movie.imdb_id)
                    url = Lampa.Utils.addUrlComponent(
                        url,
                        "imdb_id=" + encodeURIComponent(object.movie.imdb_id)
                    );
                if (object.movie.kinopoisk_id || object.movie.kinopoisk_ID)
                    url = Lampa.Utils.addUrlComponent(
                        url,
            ...
            var letgo = function letgo(imdb_id) {
                if (["videocdn", "videoapi"].indexOf(balanser) >= 0)
                    vcdn_search();
                    ...
                    var url_end = Lampa.Utils.addUrlComponent(
                        url,
                        imdb_id
            ...
            if (source.searchByTitle) {
                ...
                !object.movie.imdb_id &&
                (object.movie.source == "tmdb" || object.movie.source == "cub")
            ) {
                var tmdburl =
                    (object.movie.name ? "tv" : "movie") +
                    "/" +
                    object.movie.id +
                    "/external_ids?api_key=4ef0d7355d9ffb5151e987764708ce96&language=ru";
        ...
        this.normalizeTitle = function (str) {
            return this.cleanTitle(
                str.toLowerCase().replace(/—/g, "-").replace(/ё/g, "е")
            );
        };
        this.equalTitle = function (t1, t2) {
            return (
                typeof t1 === "string" &&
                typeof t2 === "string" &&
                this.normalizeTitle(t1) === this.normalizeTitle(t2)
            );
        };
        this.containsTitle = function (str, title) {
            return (
                typeof str === "string" &&
                typeof title === "string" &&
                this.normalizeTitle(str).indexOf(this.normalizeTitle(title)) !==
                    -1
            );
        };
        ...
        this.fixLink = function (link, proxy, referrer) {
            ...
            if (link) {
                ...
                if (startsWith(link, "#"))
                    return (
                        proxy + url.origin + url.pathname + url.search + link
                    );
        ...
        this.proxyUrlCall = function (
            ...
            if (!proxyInitialized[proxy_url]) {
                ...
                var proxyOrigin = proxy_url.replace(
                    /(https?:\/\/[^\/]+)\/.*/,
                    "$1"
                );
        ...
        this.proxyCall = function (
            ...
            var proxy_url =
                API.replace("api.", "").slice(0, -1) + "/proxy.html";
            this.proxyUrlCall(
                proxy_url,
                method,
                url,
        ...
        this.similars = function (json) {
            ...
            json.forEach(function (elem) {
                var info = [];
                var year = ((elem.start_date || elem.year || "") + "").slice(
                    0,
                    4
                );
                var transl = elem.translations
                    ? String(elem.translations).split(",").slice(0, 2)
                    : "";
                var count_s = elem.seasons_count
                    ? elem.seasons_count +
                      ...
                      _this3.num_word(elem.seasons_count, ["", "а", "ов"])
                    : "";
                var count_eps = elem.episodes_count
                    ? elem.episodes_count +
                      " эпизод" +
                      _this3.num_word(elem.episodes_count, ["", "а", "ов"])
                    : "";
                if (year) info.push(year);
                if (elem.type)
                    info.push(
                        elem.type == "serial" || elem.type == "MINI_SERIES"
                            ? "Cериал" +
                                  (count_s &&
                                      " - " + count_s + " из них " + count_eps)
                            : elem.type == "TV_SHOW"
                            ? "Тв-Шоу"
                ...
                elem.info = info.join(
                    '<span class="online_modss-split">●</span>'
                );
        ...
        this.filter = function (filter_items, choice) {
            ...
            if (filter_items.type && filter_items.type.length)
                add("type", Lampa.Lang.translate("filter_video_stream") + "");
            if (filter_items.server && filter_items.server.length)
            ...
            this.getEpisodes(
                ...
                function (episodes) {
                    ...
                    if (more) {
                        ...
                        ismore =
                            items[items.length - 1].episode >=
                            episodes[ep.length].episode_number;
                        if (ismore)
                            ep = episodes.slice(
                                items.length -
                                    (episodes.length - items.length <
                    ...
                    items.forEach(function (element, index) {
                        ...
                        if (element.season) {
                            element.translate_episode_end =
                                _this4.getLastEpisode(items);
                        ...
                        if (episode) {
                            ...
                            object.movie.release_date &&
                            object.movie.release_date.length > 4 &&
                            fully
                        ) {
                            info.push(
                                Lampa.Utils.parseTime(object.movie.release_date)
                                    .full
                            );
                        }
                        ...
                        if (Lampa.Timeline.details) {
                            html.find(".online_modss__timeline").append(
                                Lampa.Timeline.details(element.timeline)
                            );
                        }
                        ...
                        element.mark = function () {
                            ...
                            if (viewed.indexOf(hash_behold) == -1) {
                                ...
                                if (
                                    html.find(".online_modss__viewed").length ==
                                    0
                                ) {
                                    html.find(".online_modss__img").append(
                                        '<div class="online-prestige__viewed online_modss__viewed">' +
                            ...
                            if (!serial) {
                                ...
                                choice.episodes_view[element.season] =
                                    episode_num;
                            }
                        ...
                        html.on("hover:enter", function () {
                            ...
                            if (["kinopub", "collaps"].indexOf(balanser) >= 0) {
                                ...
                                $(".explorer-card__descr")
                                    .hide()
                                    .after('<div class="voices"></div>');
                                $(".voices").html(
                                    Lampa.Lang.translate(
                                        "<b>#{torrent_parser_voice}:</b><br>" +
                                            element.voice
                                    )
                                );
                            }
                    ...
                    if (
                        ...
                        left.forEach(function (episode) {
                            ...
                            var air = new Date(
                                (episode.air_date + "").replace(/-/g, "/")
                            );
                            var now = Date.now();
                            var day = Math.round(
                                (air.getTime() - now) / (24 * 60 * 60 * 1000)
                            );
                            var txt =
                            ...
                            if (episode.still_path) {
                                ...
                                image.append(
                                    '<div class="online_modss__episode-number">' +
                                        ("0" + episode.episode_number).slice(
                                            -2
                                        ) +
                                        "</div>"
                                );
                ...
                .on("hover:long", function () {
                    function show(extra) {
                        ...
                        if (Lampa.Platform.is("webos")) {
                            menu.push({
                                title:
                                    Lampa.Lang.translate("player_lauch") +
                                    " - Webos",
                                player: "webos",
                            });
                        }
                        ...
                        Lampa.Select.show({
                            ...
                            onSelect: function onSelect(a) {
                                ...
                                if (a.speed) {
                                    Modss.speedTest(extra.file, {
                                        title: object.search,
                                        info: [
                                            params.element.title,
                                            params.element.quality,
                                        ].join(" - "),
                                        balanser:
                                            ((["kinopub", "hdr"].indexOf(
                                                balanser
                                    ...
                                    Lampa.Account.subscribeToTranslation(
                                        {
                                            ...
                                            episode:
                                                params.element
                                                    .translate_episode_end,
                                            voice: params.element
                                                .translate_voice,
                                        },
                                        function () {
                                            Lampa.Noty.show(
        ...
        this.empty = function (er) {
            ...
            html.find(".online-empty__title").text(
                er && er.vip
                    ? er.vip.title
                    : Lampa.Lang.translate("empty_title_two")
            );
            html.find(".online-empty__time").text(
                er && er.vip
                    ...
                    : er
                    ? er
                    : Lampa.Lang.translate("empty_text")
            );
            scroll.append(html);
            this.loading(false);
        ...
        this.doesNotAnswer = function (query) {
            ...
            balanser_timer = setInterval(function () {
                ...
                if (tic == 0) {
                    ...
                    if (!next) next = keys[0];
                    balanser = next;
                    if (Lampa.Activity.active().activity == _this6.activity)
                        _this6.changeBalanser(balanser);
                }
            }, 1000);
            scroll.append(html);
            this.loading(false);
        ...
        this.new_seria = function () {
            if (object.movie.number_of_seasons) {
                setTimeout(function () {
                    $(
                        ".card--new_ser, .card--viewed, .full-start__right .time-line, .card--last_view"
                    ).remove();
                    if ($("body").find(".online").length !== 0) {
                        if (
                            $("body").find(
                                ".online:last-child .torrent-item__viewed"
                            ).length == 1 ||
                            $("body").find(".online:last-child .time-line.hide")
                                .length == 0
                        )
                            $("body")
            ...
            Lampa.Controller.add("content", {
                ...
                right: function right() {
                    if (Navigator.canmove("right")) Navigator.move("right");
                        ...
                        filter.show(
                            Lampa.Lang.translate("title_filter"),
                            "filter"
                        );
                    else
                        filter.show(
                            Lampa.Lang.translate("modss_balanser"),
                            "sort"
                        );
                },
                left: function left() {
    ...
    function forktv(object) {
        ...
        this.stream = function (data, title, youtube, subs, element, view) {
            ...
            if (
                ...
                (data.indexOf("rgfoot") > -1 ||
                    data.indexOf("torrstream") > -1 ||
                    data.indexOf("torrent") > -1)
            ) {
                this.activity.loader(true);
                network.timeout(10000);
                network["native"](
                    ...
                    function (json) {
                        ...
                        if (json.channels.length > 0) {
                            ...
                            Lampa.Noty.show(
                                Lampa.Lang.translate("online_nolink")
                            );
                    },
                    function (a, e) {
                        _this.activity.loader(false);
                ...
                data &&
                data.match(/magnet|videos|stream\\?|mp4|mkv|m3u8/i)
            ) {
        ...
        this.append = function (data) {
            var _this3 = this;
            var viewed = Lampa.Storage.cache("online_view", 5000, []);
            var bg_img = JSON.stringify(data).replace(
                "background-image",
                "background_image"
            );
            bg_img = JSON.parse(bg_img);
            bg_img.background_image &&
                Lampa.Background.immediately(bg_img.background_image);
            if (data.channels && data.channels.length == 0) {
                ...
                var json =
                    ...
                    data.next_page_url.indexOf("page=1") > -1
                        ...
                        : object.title == "SerialHD" &&
                          data.next_page_url &&
                          data.next_page_url.split("page=")[1] != 2
                ...
                if (data.title == "HDGO") {
                    [
                        ...
                        _this3.appendHdgo({
                            title: i.name,
                            results: JSON.parse(json).filter(function (
                                element,
                                id
                            ) {
                    ...
                    var voic =
                        ...
                        (infos &&
                            infos.match(
                                /Перевод:(.*?)(<br|Разм|Обн|Реж|Вр|Фор)/
                            )) ||
                        "";
                    if (
                        (element.template &&
                            element.template.indexOf("film.") > -1) ||
                        (element.logo_30x30 &&
                            element.logo_30x30.match("mediafil")) ||
                        (element.logo_30x30 &&
                            element.logo_30x30.match("folder") &&
                            element.playlist_url &&
                            element.playlist_url.indexOf("torrstream?magnet") >
                                -1)
                    ) {
                        var image =
                        ...
                        if (element.title.match("Описание|Трейлер") == null) {
                            if (
                                ...
                                if (
                                    ...
                                    stream &&
                                    stream.match(
                                        /torrstream\\?magnet|getstream|kinomix/
                                    )
                                ) {
                                    var des = $(
                                    ...
                                    var vo =
                                        des.match(/Озвучка(.*?)Вид/) ||
                                        des.match(/Перевод:(.*?)Разм/);
                                    var vid =
                                        des.match(/Видео[:](.*?)[|]/) ||
                                    ...
                                    var sed_per =
                                        des.match(
                                            /Раздают:(.*?)Качают:(.*?)(Обн|Кач|Длит)/
                                        ) ||
                                        des.match(
                                            /Раздают:(.*?)\\s[|]\\sКачают:(.*?)(Обн|Кач|Длит)/
                                        );
                                    var size1 =
                                        des.match(/t\/s(.*?)Озв/) ||
                                ...
                                var card = Lampa.Template.get(
                                    "onlines_v1",
                                    element
                                );
                                var hash = Lampa.Utils.hash(
                                    [element.title, element.ident, stream].join(
                                        ""
                                    )
                                );
                                var view = Lampa.Timeline.view(hash);
                                ...
                                if (Lampa.Timeline.details)
                                    card.find(".online__quality").append(
                                ...
                                var image =
                                    element.before &&
                                    element.before.indexOf("src") > -1
                                        ? $("img", element.before).attr("src")
                                        : element.template &&
                                          element.template.indexOf("src") > -1
                                        ? $("img", element.template).attr("src")
                                        : element.description &&
                                          element.description.indexOf("src") >
                                              -1
                                        ? $("img", element.description).attr(
                                              "src"
                                          )
                                        : element.logo_30x30 &&
                                          element.logo_30x30.indexOf("png") > -1
                                ...
                                if (!element.search_on) {
                                    var time = $(
                                        $(element.description).children()[0]
                                    )
                                        .parent()
                                        .text();
                                    time = time.match(
                                    ...
                                    var descr =
                                        !element.ident &&
                                        element.description &&
                                        $($(element.description).children()[1])
                                            ? $(
                                                  $(
                                                      element.description
                                                  ).children()[1]
                                    ...
                                    isNaN(element.ident) &&
                                        (element.home ||
                                            ...
                                            (element.playlist_url &&
                                                ...
                                                object.title.indexOf("HDGO") >
                                                    -1) ||
                                            (element.logo_30x30 &&
                                                element.logo_30x30.indexOf(
                                                    "webcam"
                                                ) > -1))
                                        ? "card--collection"
                                        : "card--category"
                                ...
                                if (
                                    ...
                                    card.addClass("pc");
                                if (
                                    (/Mozilla/i.test(navigator.userAgent) &&
                                        !/Android/i.test(
                                            navigator.userAgent
                                        )) ||
                                    Lampa.Platform.tv()
                                ...
                                if (
                                    ...
                                    card.addClass("card--category").removeClass(
                                        "card--collection"
                                    );
                                if (
                                    element.logo_30x30 &&
                                    element.logo_30x30.match(
                                        /country|genre|filter|mediafolder/g
                                    ) != null
                                )
                                    card.addClass("hdgo");
                                if (
                                    ...
                                    stream.match(
                                        /stream|magnet|view\?|view=|\/details/g
                                    )
                                )
                                    card.addClass(
                                        "mobile card--category"
                                    ).removeClass("card--collection");
                                if (
                                    element.logo_30x30 &&
                                    element.logo_30x30.indexOf("/folder.") >
                                        -1 &&
                                    stream.match(/view=/g)
                                )
                                    card.addClass(
                                        ...
                                        "card--collection nuam mobile"
                                    );
                                if (
                                    element.logo_30x30 &&
                                    element.logo_30x30.match(/mediafolder/g)
                                )
                                    card.addClass("card--category").removeClass(
                                        "card--collection"
                                    );
                                if (
                                    bg_img.background_image &&
                                    bg_img.background_image.indexOf("18") >
                                        -1 &&
                                    data.next_page_url &&
                                    data.next_page_url.indexOf("girl") > -1 &&
                                    ...
                                    card.addClass("card--category").removeClass(
                                        "nuam hdgo mobile card--collection"
                                    );
                                ...
                                if (
                                    ...
                                    card.addClass(
                                        ...
                                        "nuam hdgo mobile card--category"
                                    );
                                if (
                                    object.title.match(/Торренты|ForkTV|18\\+/g)
                                )
                                    card.addClass("home");
                                if (
                                    element.logo_30x30 &&
                                    element.logo_30x30.match(
                                        /country|genre|filter/g
                                    )
                                )
                                    card.addClass("sort");
                                if (
                                    ((stream &&
                                        stream.match(
                                            /filmix\\?subcategory|rutor/
                                        )) ||
                                        (element.submenu &&
                                            element.submenu[0] &&
                                            element.submenu[0].playlist_url &&
                                            element.submenu[0].playlist_url.indexOf(
                                                "rutor"
                                            ) > -1)) &&
                                    element.logo_30x30 &&
                            ...
                            card.on("hover:focus hover:touch", function () {
                                if (
                                    this.className.indexOf("card--category") >
                                    -1
                                ) {
                                    if (Lampa.Helper)
                                        Lampa.Helper.show(
                                ...
                                if (
                                    Math.ceil(items.indexOf(card) / 7) >= maxrow
                                )
                                ...
                                .on("hover:long", function () {
                                    if (
                                        stream &&
                                        stream.match("bonga|chatur|rgfoot") ==
                                            null &&
                                    ...
                                    if (
                                        ...
                                        stream &&
                                        stream.match(
                                            "torrstream|getstream|mp4|kinomix"
                                        ) == null &&
                                        stream.match(
        ...
        this.createHdGO = function (data) {
            ...
            this.item = function (data) {
                ...
                if (
                    /iPhone|x11|nt|Mozilla/i.test(navigator.userAgent) ||
                    Lampa.Platform.tv()
                )
                    item.addClass("card--collection")
                        ...
                        .remove();
                if (
                    /iPhone|x11|nt/i.test(navigator.userAgent) &&
                    !Lampa.Platform.is("android")
                )
                        ...
                        if (element.search_on) {
                            Lampa.Input.edit(
                                ...
                                function (new_value) {
                                    ...
                                    var u =
                                        element.playlist_url &&
                                        element.playlist_url.indexOf("?") > -1
                                            ? "&"
                                            : "/?";
                                    network["native"](
                                        element.playlist_url +
                ...
                onSelect: function onSelect(a) {
                    ...
                    if (a.copylink) {
                        Lampa.Utils.copyTextToClipboard(
                            ...
                            function () {
                                Lampa.Noty.show(
                                    Lampa.Lang.translate("copy_error")
                                );
                            }
                        );
                    }
    ...
    function collection(object) {
        ...
        this.create = function () {
            ...
            if (object.sourc == "my_coll") {
                ...
                if (
                    ...
                    object.cards ||
                    (!object.card &&
                        !Lampa.Storage.field("light_version") &&
                        object.card_cat)
                ) {
                    this.activity.loader(true);
                    network.silent(
        ...
        this.next = function (page) {
            ...
            if (object.sourc == "pub" && object.sour !== "rezka")
                ...
                (object.sourc == "rezka" || object.sour == "rezka") &&
                object.data &&
                object.data.page
            )
        ...
        this.append = function (data, append) {
            var _this1 = this;
            var datas = Lampa.Arrays.isArray(data.card)
                ? data.card
                : Lampa.Arrays.getValues(data.card).reverse();
                        ...
                        Lampa.Api.search(
                            ...
                            function (find) {
                                ...
                                if (finded) {
                                    ...
                                    Lampa.Noty.show(
                                        Lampa.Lang.translate("nofind_movie")
                                    );
                                    Lampa.Controller.toggle("content");
                                }
                            },
                        ...
                        items.push(
                            {
                                ...
                                subtitle:
                                    Lampa.Lang.translate("card_book_descr"),
                                where: "book",
                            },
                            {
                                title: status.like
                                ...
                                subtitle:
                                    Lampa.Lang.translate("card_like_descr"),
                                where: "like",
                            },
                            {
                                title: status.wath
                                ...
                                subtitle:
                                    Lampa.Lang.translate("card_wath_descr"),
                                where: "wath",
                            },
                            {
                                ...
                                subtitle:
                                    Lampa.Lang.translate("card_history_descr"),
                                where: "history",
                            }
                        );
                    }
        ...
        this.addicon = function (name, card) {
            card.find(".card__icons-inner").append(
                '<div class="card__icon icon--' + name + '"></div>'
            );
        };
            ...
            if (!cache["id_" + data.id]) {
                ...
                Lampa.Activity.push({
                    ...
                    title:
                        ...
                        "- " +
                        Lampa.Arrays.getKeys(cache).length,
                    card_cat: true,
                    category: true,
                    component: "collection",
                    page: 1,
        ...
        this.build = function (data) {
            ...
            if (data.card.length || Lampa.Arrays.getKeys(data.card).length) {
                ...
                info.find(".view--category").on(
                    "hover:enter hover:click",
                    function () {
                        Lampa.Input.edit(
                            {
                                value: "",
        ...
        this.back = function () {
            ...
            var more = $(
                '<div class="selector" style="width: 100%; height: 5px"></div>'
            );
        ...
        this.card = function (str) {
            ...
            if (
                ...
                $(h).each(function (i, html) {
                    card.push({
                        id: $("a", html)
                            ...
                            .pop(),
                        title:
                            $("a:eq(1)", html).text().split(" / ").shift() ||
                            $(".title", html).text(),
                        title_org: $("a:eq(1)", html)
                            .text()
                            .split(" / ")
                            .shift(),
                ...
                (object.card && object.card.source == "filmix") ||
                object.sourc == "filmix"
            ) {
                    ...
                    if (html.tagName == "ARTICLE")
                        card.push({
                            ...
                            title:
                                ...
                                ($(".poster", html).attr("alt") &&
                                    $(".poster", html)
                                        .attr("alt")
                                        .split(",")
                                        .shift()),
                            title_org:
                                $(".m-movie-original", html).text() ||
                                $(".origin-name", html).text(),
                            url: $("a", html).attr("href"),
                            img: $("img", html).attr("src"),
                            quantity:
                                $(".m-movie-quantity", html).text() ||
                                $(".count", html).text(),
                            year:
                                $(".grid-item", html).text() ||
                                ($(".poster", html).attr("alt") &&
                ...
                (object.card && object.card.source == "pub") ||
                object.sourc == "pub"
            ) {
                str = JSON.parse(str);
                if (str.pagination) {
                ...
                if (str.items)
                    str.items.forEach(function (element) {
                        card.push({
                            ...
                            original_title:
                                element.title.split("/")[1] || element.title,
            ...
            },
            {
                ...
                value: function startLongPress() {
                    ...
                    this.longPressTimeout = setTimeout(function () {
                        ...
                        _this.originalUserSelect =
                            _this.targetElement.style.userSelect; // Сохраняем исходное значение
                        _this.originalWebkitUserSelect =
                            _this.targetElement.style.WebkitUserSelect; // Сохраняем исходное значение
    ...
    function setupAudio() {
        ...
        if (typeof Audio !== "undefined") {
            ...
            try {
                ...
                console.error(
                    "Modss",
                    "Ошибка при создании AudioContext:",
                    error
                );
            }
            ...
            if (
                _audio &&
                _context &&
                typeof _context.createMediaElementSource === "function"
            ) {
                ...
                console.error(
                    "Modss",
                    "Audio API не поддерживается в этом браузере"
                );
            }
        } else {
            console.error(
            ...
            Api.network.native(
                ...
                function (data) {
                    ...
                    var filtered = data["results"].filter(function (r) {
                        r.collectionNameLC = r.collectionName
                            ? r.collectionName.toLowerCase().replace(regex, "")
                            : "";
                        return (
                            r.collectionNameLC &&
                    ...
                    if (!filtered.length) {
                        ...
                        var accuracyMaxLen =
                            (albumLC.length * accuracyPercent) / 100;
                        filtered = data["results"]
                            .filter(function (r) {
                                r.levenshtein = levenshtein(
                                    r.collectionNameLC,
                                    albumLC
                                );
                    ...
                    if (!filtered.length || !filtered[0]["artworkUrl100"]) {
                        ...
                        bigCover = filtered[0]["artworkUrl100"].replace(
                            "100x100bb.jpg",
                            "500x500bb.jpg"
        ...
        return _createClass(Api, null, [
            {
                ...
                value: function list(obj) {
                    ...
                    return new Promise(function (resolve, reject) {
                        var url =
                            (obj.url == "" && _this.stantion()[0].url) ||
                            obj.url;
                        var cacheName =
                            "radio_list_" +
                            ((obj.url == "" && _this.stantion()[0].title) ||
                                obj.title);
                        //console.log('Api', 'GET', {obj, url,cacheName})
                        _this.network["native"](
                            url,
                            function (result) {
                                Lampa.Cache.rewriteData(
                                    "other",
                                    cacheName,
                                    result
                                )["finally"](resolve.bind(resolve, result));
                            },
                            function () {
                                Lampa.Cache.getData("other", cacheName)
                                    .then(resolve)
                                    ["catch"](reject);
                            }
                        );
    ...
    function Info(station, Player) {
        ...
        this.create = function () {
            ...
            cover
                .find(".m-radio-cover__station")
                .text(station.title || station.name || "");
            cover.find(".m-radio-cover__genre").text(station.genres || "");
            cover
                .find(".m-radio-cover__tooltip")
                .text(station.description || station.tooltip || "");
            cover
                .find(".m-radio-cover__album span")
                .text(station.dj ? "DJ – " + station.dj : "");
            ...
            img_elm.src =
                station.largeimage ||
                station.image ||
                station.bg_image_mobile ||
                station.picture; // image - 120 | largeimage - 256 | xlimage 512
        ...
        this.update_info = function () {
            var setTrackCover = function setTrackCover(cover) {
                img_elm.src =
                    ...
                    station.largeimage ||
                    station.image ||
                    station.bg_image; // image - 120 | largeimage - 256 | xlimage 512
            ...
            var updatePlayingInfo = function updatePlayingInfo(playingTrack) {
                ...
                var album_info = album_cont
                    .find("span")
                    .text(playingTrack.album || "");
                var album_svg = album_cont.find("svg");
                playingTrack.album
                    ? (album_svg.style.width = "1em")
                    : (album_svg.style.width = "0em");
                info_html
                    .find(".m-radio-cover__title")
                    .text(playingTrack.title || "");
                info_html
                    .find(".m-radio-cover__tooltip")
                    .text(playingTrack.artist || playingTrack.tooltip || "");

                var coverKey = isSupportWebp() ? "cover_webp" : "cover";
                var img = playingTrack[coverKey]
                    ? playingTrack.root + playingTrack[coverKey]
                    : "";
            ...
            var fetchSongs = function fetchSongs(channel, callback) {
                ...
                var error =
                    "There was a problem loading the list of songs for channel " +
                    title +
                    " from SomaFM.";
                    ...
                    var graphicsManager = {
                        ...
                        Sphere: {
                            ...
                            create: function (containerBounds, scene) {
                                ...
                                var smallCircleGeometry =
                                    new THREE.CircleGeometry(1, 10);
                                var largeCircleGeometry =
                            ...
                            update: function (
                                ...
                                var xOffset =
                                    containerBounds.width < 800 ? 0 : 40;
                                var zOffset =
                                    containerBounds.width < 800 ? -60 : 20;
                                ...
                                if (this.touch) {
                                    ...
                                    this.move.x =
                                        xOffset + -0.012 * mousePosition.x;
                                    this.group.position.x +=
                                        (this.move.x - this.group.position.x) /
                                        this.ease;
                                    this.group.position.y +=
                                        (this.move.y - this.group.position.y) /
                                        this.ease;
                                }

                                this.group.position.z =
                                    zOffset + 80 * audioData;
                        ...
                        setupCanvas: function () {
                            this._wrap =
                                document.querySelector(".m-radio-player");
                            this._canvas =
                                document.querySelector("#player-canvas");
                        ...
                        updateMouse: function (event) {
                            if (this._box) {
                                var centerX =
                                    this._box.left + this._box.width / 2;
                                var centerY =
                                    this._box.top + this._box.height / 2;

                                if (event) {
                                    this._mouse.x =
                                        Math.max(
                                            0,
                                            event.pageX || event.clientX || 0
                                        ) - centerX;
                                    this._mouse.y =
                                        Math.max(
                                            0,
                                            event.pageY || event.clientY || 0
                                        ) - centerY;
                                } else {
    ...
    function Player() {
        ...
        var player_html =
            (miniPlayer.length && miniPlayer) ||
            Lampa.Template.get("modss_radio_play_player", {});
        var cover_html =
            (cover.length && cover) ||
            Lampa.Template.get("modss_radio_cover", {});
        ...
        [player_html, cover_html].forEach(function (btn) {
            btn.on("hover:enter", function () {
                if (played) {
                    html.find(".m-radio-item")
                        .filter(".play")
                        .toggleClass("play", false)
                        .toggleClass("stop", true);
                    stop();
                } else if (url) {
                    html.find(".m-radio-item")
                        .filter(".stop")
                        .toggleClass("play", true)
                        .toggleClass("stop", false);
                    play();
                }
            });
                    ...
                    hls.on(Hls.Events.ERROR, function (event, data) {
                        if (
                            ...
                            if (data.reason === "no EXTM3U delimiter") {
                                Lampa.Noty.show(
                                    Lampa.Lang.translate("radio_load_error")
                                );
                            }
                        }
                    });
            ...
            if (_context.state === "suspended") {
                _context.resume().then(function () {
                    console.log(
                        "Modss",
                        "Modss_Radio",
                        "Audio context has been resumed."
                    );
                });
            }
            player_html.toggleClass("loading", true);
        ...
        this.changeWave = function changeWave(class_name, liness) {
            var lines =
                (liness &&
                    liness
                        .find(".m-radio-player__wave")
                        .querySelectorAll("div")) ||
                (html.find(".m-radio-player__wave").length &&
                    html.find(".m-radio-player__wave")[0].children) ||
                false;
            for (var i = 0; i < lines.length; i++) {
                ...
                if (class_name == "stop") lines[i].style = "";
                    ...
                    lines[i].style["animation-duration"] =
                        (class_name == "loading"
                            ? 400
                            : 200 + Math.random() * 200) + "ms";
                    lines[i].style["animation-delay"] =
                        (class_name == "loading"
                            ? Math.round((400 / lines.length) * i)
                            : 0) + "ms";
                }
            }
        };
        ...
        this.play = function (stations) {
            ...
            if (btn) {
                btn.css({
                    "background-image":
                        "url('" +
                        (station.bg_image_mobile || station.image) +
                        "')",
    ...
    function Radio_n(object) {
        ...
        this.create = function () {
            ...
            var last_st = Lampa.Arrays.getKeys(cache).reduce(function (
                result,
                key
            ) {
                if (
                    cache[key].hasOwnProperty("last") &&
                    cache[key].last === true
                ) {
                    result = cache[key];
                    result.key = key;
            ...
            Api.list(object)
                .then(function (result) {
                    ...
                    if (last_st.id == -1 && Favorites.get().length)
                        ...
                        filtred =
                            (_this6.data.stations && _this6.data.stations) ||
                            _this6.data;
        ...
        this.buildChanel = function (result) {
            if (object.id == 2) {
                ...
                var getUrlsFromPlaylist = function getUrlsFromPlaylist(
                    playlistUrl
                ) {
                    return new Promise(function (resolve, reject) {
                        var error =
                            "There was a problem parse urls from playlist " +
                            playlistUrl +
                            " from SomaFM.";
                        Api.network.timeout(5000);
                        Api.network.native(
                ...
                var getHighestQualityStream = function getHighestQualityStream(
                    channel,
                    streams
                ) {
                    for (var ks in streams) {
                        ...
                        for (var kp in channel.playlists) {
                            ...
                            if (
                                (!stream.urlRegex ||
                                    stream.urlRegex.test(playlist.url)) &&
                                (!stream.quality ||
                                    playlist.quality === stream.quality) &&
                                (!stream.format ||
                                    playlist.format === stream.format)
                            ) {
                                return {
                                    url: playlist.url,
                ...
                _this6.data.stations = Lampa.Arrays.getKeys(
                    ...
                    if (Array.isArray(station.playlists)) {
                        ...
                        station.songsurl =
                            url + "/songs/" + station.id + ".json";
                        station.infourl = url + "/" + station.id + "/";
                        station.stream = getHighestQualityStream(
                            station,
                            PREFERRED_STREAMS
                        );
                ...
                _this6.data.stations = Object.keys(result).map(function (
                    key,
                    i
                ) {
                ...
                _this6.data.genre = Object.keys(_this6.data.genre).map(
                    function (key) {
        ...
        this.background = function () {
            Lampa.Background.immediately(
                last ? last.background || img_bg : img_bg
            );
        };
        this.build = function () {
            var _this2 = this;
            ...
            html.find(".m-radio-content__cover").append(
                Lampa.Template.js("modss_radio_cover")
            );
            ...
            btn.on("hover:enter", function () {
                Lampa.Select.show({
                    ...
                    items: items.map(function (s) {
                        s.selected =
                            s.title ==
                            ((object.url == "" && Api.stantion()[0].title) ||
                                object.title);
                        return s;
                    }),
                    onSelect: function onSelect(a) {
        ...
        this.buildCatalog = function () {
            ...
            if (this.data.stations && this.data.stations.length) {
                items.push({
                    title:
                        Lampa.Lang.translate(
                            "settings_param_jackett_interview_all"
                        ) +
                        " [" +
                    ...
                    function (val) {
                        if (val) {
                            ...
                            filtred = _this5.data.stations.filter(function (s) {
                                return (
                                    s.title.toLowerCase().indexOf(val) >= 0 ||
                                    s.tooltip.toLowerCase().indexOf(val) >= 0
                                );
                            });
        ...
        this.play = function (station) {
            ...
            Lampa.Background.change(
                station.bg_image_mobile || station.image || img_bg
            );
        };
        ...
        this.next = function () {
            ...
            if (filtred.length > 100)
                filtred
                    .slice(start, start + views)
                    .forEach(_this6.append.bind(_this6));
        ...
        this.append = function (station) {
            ...
            item.find(".m-radio-item__num").text(
                (filtred.indexOf(station) + 1).pad(2)
            );
            item.find(".m-radio-item__title").text(
            ...
            img_elm.src =
                station.bg_image_mobile || station.image || station.picture;
            ...
            item.on("hover:long", function () {
                if (station.user) {
                    ...
                    item.toggleClass(
                        "favorite",
                        Boolean(Favorites.find(station))
                    );
                }
            });
        ...
        this.cover = function (station) {
            html.find(".m-radio-cover__title").text(
                station.title || station.name || ""
            );
                ...
                if (items[pos]) {
                    if ($("body").hasClass("ambience--enable")) {
                        ...
                        $("body")
                            ...
                            .text(
                                (filtred[pos + down] &&
                                    (filtred[pos + down].title ||
                                        filtred[pos + down].name)) ||
                                    filtred[pos].title ||
                                    filtred[pos].name
                            );
                    }
            ...
            Lampa.Controller.add("content", {
                ...
                left: function left() {
                    if (
                        ...
                        !$("body")
                            .find(".m-radio-cover__img-container")
                            .hasClass("focus")
                    )
                        return;
    ...
    function startPlugin() {
		...
		*/
        ...
        manifest = {
            ...
            description: "Онлайн (23 Balansers, 19 in VIP)",
            component: "modss_online",
                    ...
                    setTimeout(function () {
                        ...
                        if (Lampa.Storage.field("parser_use")) {
                            ...
                            if (
                                Boolean(
                                    Modss.jack[
                                        Lampa.Storage.get("jackett_url2")
                                    ]
                                )
                            )
                            ...
                            $(
                                '[data-name="jackett_url"] .settings-param__name'
                            ).before(
                                '<div class="settings-param__status wait act"></div>'
                            );
                            $(".settings-param__name", item).css(
                                "color",
                                "#f3d900"
                            );
                            $('div[data-name="jackett_url2"]').insertAfter(
                                'div[data-children="parser"]'
                            );
                            Modss.check(
                                $(".settings-param__value", item)
                                    .text()
                                    .toLowerCase()
                                    .replace(/\./g, "_"),
                                function (e) {
        ...
        Lampa.Listener.follow("activity", function (e) {
            if (e.component == "full" && e.type == "start") {
                var button = Lampa.Activity.active()
                    .activity.render()
                    .find(".view--modss_online");
                if (button.length) {
                    cards = e.object.card;
        ...
        Lampa.Settings.listener.follow("open", function (e) {
            if (e.name == "main") {
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="pub_param"]').length == 0
                ) {
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="fork_param"]').length == 0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="rezka_param"]').length == 0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="filmix_param"]').length == 0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="modss_tv_param"]').length == 0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="modss_online_param"]').length ==
                    0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                if (
                    Lampa.Settings.main()
                        .render()
                        .find('[data-component="modss_radio_param"]').length ==
                    0
                ) {
                    Lampa.SettingsApi.addComponent({
                ...
                var interfaceElement = Lampa.Settings.main()
                    .render()
                    .find('div[data-component="tmdb"]');
                var settingsElement = Lampa.Settings.main()
                    .render()
                    .find('div[data-component="settings_modss"]');

                interfaceElement.after(settingsElement);
            }
            if (e.name == "mods_proxy") {
                $(".settings__title").text(
                    Lampa.Lang.translate("title_proxy") + " MODS's"
                );
                var ads = [
                ...
                e.body
                    .find('[data-name="mods_proxy_all"]')
                    .before(Lampa.Lang.translate(ads));
            ...
            if (e.name == "filmix_param") {
                ...
                e.body
                    .find('[data-static="true"]:eq(0)')
                    .after(Lampa.Lang.translate(ads));
            ...
            if (e.name == "modss_online_param") {
                ...
                var title = $(
                    '[data-name="priority_balanser"] .settings-param__value',
                    e.body
                );
        ...
        function add() {
            ...
            Lampa.SettingsApi.addParam({
                ...
                onRender: function (item) {
                    ...
                    if (Lampa.Storage.get("mods_password"))
                        item.find(".settings-param__descr").text(
                            "Изменить пароль"
                        );
                    else
                        item.find(".settings-param__descr").text(
                            Lampa.Lang.translate("placeholder_password")
                        );
                },
                onChange: function (value) {
                    if (value)
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    ...
                    description:
                        Lampa.Lang.translate("modss_balanser") + " Collaps",
                },
                onRender: function (item) {
                    if (Lampa.Storage.field("mods_onl")) item.show();
                    else item.hide();
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    name:
                        '<b style="color:#fff">' +
                        Lampa.Lang.translate("title_status") +
                        "</b>",
                    description: " ",
                },
                onRender: function (item) {
                    $(".settings-param__descr", item).before(
                        '<div class="settings-param__status"></div>'
                    );
                    Filmix.showStatus(item);
                },
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    name:
                        Lampa.Lang.translate("filmix_params_add_device") +
                        " Filmix",
            ...
            Lampa.SettingsApi.addParam({
                ...
                onRender: function (item) {
                    item.on("hover:enter", function () {
                        Lampa.Noty.show(
                            Lampa.Lang.translate("pub_source_add_noty")
                        );
            ...
            Lampa.SettingsApi.addParam({
                ...
                onRender: function (item) {
                    ...
                    item.on("hover:enter", function () {
                        ...
                        Lampa.Noty.show(
                            Lampa.Lang.translate("title_fork_clear_noty")
                        );
                    });
                },
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function (value) {
                    if (value == "true") Modss.collections();
                        ...
                        $("body")
                            .find('.menu [data-action="collection"]')
                            .remove();
                },
            });
            //Styles
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function (value) {
                    if (
                        value == "true" &&
                        $("body").find(".full-start__poster").length
                    )
                        Modss.serialInfo(cards);
                    else
                        $("body")
                            .find(
                                ".files__left .time-line, .card--last_view, .card--new_seria"
                            )
                            .remove();
                },
            });
            ...
            ["Filmix"].forEach(function (itm) {
                Lampa.SettingsApi.addParam({
                    ...
                    param: {
                        ...
                        default: Lampa.Platform.is("android") ? "off" : "on",
                    },
                    field: {
                        name: itm,
                        description:
                            Lampa.Storage.get(
                                "onl_mods_proxy_" + itm.toLowerCase()
                            ) || " ",
                    },
                    onRender: function (item) {
                        var url = Lampa.Storage.get(
                            "onl_mods_proxy_" + itm.toLowerCase()
                        );
                        if (url.length > 0)
                            item.find(".settings-param__descr").text(url);
                        if (url.length == 0)
                            item.find(".settings-param__descr").addClass(
                                "hide"
                            );
        ...
        function tocard(element) {
            return {
                ...
                first_air_date:
                    element.type == "serial" ||
                    element.type == "docuserial" ||
                    element.type == "tvshow"
                        ? element.year
                        : "",
                vote_averagey: parseFloat(
                    (element.imdb_rating || 0) + ""
                ).toFixed(1),
                vote_average: element.imdb_rating || 0,
                poster: element.posters.big,
                cover: element.posters.wide,
                background_image: element.posters.wide,
                imdb_rating: parseFloat(element.imdb_rating || "0.0").toFixed(
                    1
                ),
                kp_rating: parseFloat(
                    element.kinopoisk_rating || "0.0"
                ).toFixed(1),
                year: element.year,
                years: element.years,
            };
        ...
        function main$2(params, oncomplite, onerror) {
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_popularfilm"),
                        "s1",
                        json
                    );
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newfilm"),
                        "s2",
                        json
                    );
                },
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_popularserial"),
                        "s3",
                        json
                    );
                    Lampa.VideoQuality.add(json.results);
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newserial"),
                        "s4",
                        json
                    );
                },
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newconcert"),
                        "s5",
                        json
                    );
                },
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newdocfilm"),
                        "s7",
                        json
                    );
                },
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newdocserial"),
                        "s8",
                        json
                    );
                },
            ...
            get$6(
                ...
                function (json) {
                    append(
                        Lampa.Lang.translate("pub_title_newtvshow"),
                        "s9",
                        json
                    );
                },
        ...
        function category$1(params, oncomplite, onerror) {
            ...
            if (params.genres) {
                get$6(
                    "v1/items?type=" +
                        type +
                        (params.genres ? "&sort=created-" : ""),
                    params,
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_new") +
                                " " +
                                params.janr.toLowerCase(),
                            "s1",
                            json
                        );
                    },
                ...
                get$6(
                    ...
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_rating") +
                                " " +
                                Name,
                            "s2",
                            json
                ...
                get$6(
                    ...
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_fresh") +
                                " " +
                                Name,
                            "s3",
                            json
                ...
                get$6(
                    ...
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_hot") + " " + Name,
                            "s4",
                            json
                        );
                    },
                ...
                get$6(
                    ...
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_new") + " " + Name,
                            "s1",
                            json
                        );
                    },
                ...
                get$6(
                    ...
                    function (json) {
                        append(
                            Lampa.Lang.translate("pub_title_popular") +
                                " " +
                                Name,
                            "s2",
                            json
        ...
        function full$1(params, oncomplite, onerror) {
            var status = new Lampa.Status(
                Lampa.Storage.get("pro_pub", false) ? 5 : 4
            );
            ...
            get$6(
                ...
                function (json) {
                    ...
                    data.movie = {
                        ...
                        name: element.seasons
                            ? element.title.split("/")[0]
                            : "",
                        original_name: element.seasons
                            ? element.title.split("/")[1]
                            : "",
                        original_language:
                        ...
                        img: element.posters.big,
                        runtime:
                            ((element.duration.average || 0) / 1000 / 6) * 100,
                        ...
                        release_date:
                            element.year ||
                            Lampa.Utils.parseTime(element.created_at).full ||
                            "0000",
                        ...
                        first_air_date:
                            ...
                            element.type == "tvshow"
                                ? element.year ||
                                  Lampa.Utils.parseTime(element.created_at)
                                      .full ||
                                  "0000"
                                : "",
                        background_image: element.posters.wide,
                        imdb_rating: parseFloat(
                            element.imdb_rating || "0.0"
                        ).toFixed(1),
                        kp_rating: parseFloat(
                            element.kinopoisk_rating || "0.0"
                        ).toFixed(1),
        ...
        function discovery() {
            return {
                ...
                onMore: function onMore(params) {
                    Lampa.Activity.push({
                        url:
                            "v1/items/search?field=title&type=" +
                            params.data.type,
                        title:
                            Lampa.Lang.translate("search") +
                            " - " +
                            params.query,
        ...
        function url$2(u) {
            ...
            if (params.genres)
                u =
                    ...
                    add$5(
                        u,
                        "orderby=date&orderdir=desc&filter=s996-" +
                            params.genres.replace("f", "g")
                    );
        ...
        function tocardf(element, type) {
            return {
                ...
                source: "filmix",
                quality:
                    (element.quality && element.quality.split(" ").shift()) ||
                    "",
                title: element.title,
                original_title: element.original_title || element.title,
                release_date:
                    element.year ||
                    (element.date && element.date.split(" ")[2]) ||
                    "0000",
                first_air_date:
                    type == "tv" ||
                    (element.serial_stats && element.serial_stats.post_id) ||
        ...
        function main$1(params, oncomplite, onerror) {
            ...
            status.onComplite = function () {
                ...
                source.forEach(function (q) {
                    if (
                        status.data[q.title] &&
                        status.data[q.title].results.length
                    ) {
            ...
            get$7(
                ...
                function (json) {
                    ...
                    data.movie = {
                        id: element.id,
                        url: url,
                        type: Lampa.Arrays.getValues(
                            element.player_links &&
                                element.player_links.playlist
                        ).length
                            ? "tv"
                            : "movie",
                        source: "filmix",
                        ...
                        original_title: element.original_title || element.title,
                        name:
                            Lampa.Arrays.getValues(
                                element.player_links &&
                                    element.player_links.playlist
                            ).length || element.last_episode
                                ? element.title
                                : "",
                        original_name: Lampa.Arrays.getValues(
                            element.player_links &&
                                element.player_links.playlist
                        ).length
                        ...
                        vote_average: parseFloat(
                            element.imdb_rating || element.kp_rating || "0"
                        ),
                        production_companies: [],
                        ...
                        seasons:
                            ...
                            null,
                        quality:
                            (element.rip && element.rip.split(" ").shift()) ||
                            "",
                        number_of_seasons: parseInt(
                            element.last_episode &&
                                ...
                                : (element.last_episode &&
                                      element.last_episode.season) ||
                                      null
                        ),
                        number_of_episodes:
                            (element.last_episode &&
                                element.last_episode.episode) ||
                            null,
                        first_air_date: Lampa.Arrays.getValues(
                            element.player_links &&
                                element.player_links.playlist
                        ).length
                    ...
                    status.append(
                        "videos",
                        videos2(element.player_links && element.player_links)
                    );
                },
                onerror
            );
                    ...
                    if (json) {
                        json.forEach(function (element) {
                            if (
                                ...
                                (element.last_episode &&
                                    element.last_episode.season) ||
                                    (element.serial_stats &&
                                        element.serial_stats.status))
                            )
                                itemss.push(
                                    tocardf(
                                        element,
