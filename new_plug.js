    ...
    (function (t) {
        (t.snowfall = function (e, i) {
            function s(s, n, a, r) {
                ...
                var p = null;
                i.image
                    ? ((p = document.createElement('img')), (p.src = i.image))
                    : ((p = document.createElement('div')), t(p).css({ background: i.flakeColor })),
            ...
            for (
                ...
                a.push(
                    new s(h(c, d - c), h(0, l), h(100 * i.minSize, 100 * i.maxSize) / 100, h(i.minSpeed, i.maxSpeed))
                );
            i.round &&
            ...
            return new Promise(function (resolve, reject) {
                ...
                Pub.network.silent(
                    ...
                    function (json) {
                        ...
                        if (
                            (!vip && logged == 'false' && leftVipD !== json.data.leftDays && auth && json.data.vip) ||
                            (vip &&
                                logged == true &&
